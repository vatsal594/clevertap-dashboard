...
firebase.auth().onAuthStateChanged(async (user) => {
  ...
  if (!userDoc.exists || userDoc.data().role !== "admin") {
    ...
    // Option 2: Show access denied (uncomment below to use)
    // document.body.innerHTML = '<div style="text-align:center;margin-top:4em;"><h2>Access Denied</h2><p>You do not have permission to view this page.</p></div>';
    return;
  }
  loadAdminPanel();
});
